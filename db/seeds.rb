...
Session.create([
    ...
    {workout_description: "calisthenic training", date: 5302021, price: 150, client_id: Client.fourth.id, trainer_id: Trainer.last.id},
    {workout_description: "calisthenic training", date: 5302021, price: 75, client_id: Client.fifth.id, trainer_id: Trainer.last.id},
    ...
    {workout_description: "calisthenic training", date: 5302021, price: 150, client_id: Client.find(12).id, trainer_id: Trainer.find(7).id},
    {workout_description: "calisthenic training", date: 5302021, price: 75, client_id: Client.find(13).id, trainer_id: Trainer.find(8).id},
    ...
    {workout_description: "calisthenic training", date: 5302021, price: 100, client_id: Client.find(17).id, trainer_id: Trainer.find(12).id},
